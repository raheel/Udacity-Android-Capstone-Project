...
public class MaintenanceItemContentValues extends AbstractContentValues {
    ...
    public MaintenanceItemContentValues putLaborUnits(@Nullable Integer value) {
    ...
    public MaintenanceItemContentValues putPartUnits(@Nullable Integer value) {
    ...
    public MaintenanceItemContentValues putVehicleId(@Nullable Integer value) {
